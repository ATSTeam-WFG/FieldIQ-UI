...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-[8px] text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-[#c4a574] text-white hover:bg-[#a68751]',
        destructive: 'bg-[#d97706] text-white hover:bg-[#b45309]',
        outline: 'border border-[var(--border)] bg-transparent hover:bg-[var(--surface)] text-[var(--foreground)]',
        secondary: 'bg-[var(--surface)] text-[var(--body)] hover:bg-[var(--border)]',
        ghost: 'hover:bg-[var(--surface)] text-[var(--body)]',
        link: 'text-[#c4a574] underline-offset-4 hover:underline',
      },
      size: {
